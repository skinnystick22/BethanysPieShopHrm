...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<JobCategory>()
            .HasData(new JobCategory {JobCategoryId = 1, JobCategoryName = "Pie research"});
        modelBuilder.Entity<JobCategory>()
            .HasData(new JobCategory {JobCategoryId = 2, JobCategoryName = "Sales"});
        modelBuilder.Entity<JobCategory>().HasData(new JobCategory {JobCategoryId = 3, JobCategoryName = "Management"});
        modelBuilder.Entity<JobCategory>()
            .HasData(new JobCategory {JobCategoryId = 4, JobCategoryName = "Store staff"});
        modelBuilder.Entity<JobCategory>()
        ...
        modelBuilder.Entity<JobCategory>()
            .HasData(new JobCategory {JobCategoryId = 9, JobCategoryName = "Bakery"});
